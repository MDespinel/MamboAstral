...
const Checkout = () => {
    ...
    const validateForm = () => {
        ...
        if(!user.email){
            errors.email = 'Por favor agrega un email'
        ...
        if(!user.phone){
            errors.phone ="tenes que agregar un telefono"
    ...
    const getOrder = async () => {
        ...
        if(cart.length === 0){
            Swal.fire({
                ...
                text: `Debes agregar productos al carrito para que se genere la orden`,
                icon: "error",
        ...
        try {
            for(const item of cart) {
                ...
                if(currentStock >= item.quantity){
                    ...
                    Swal.fire({
                        title: "No hay stock",
                        text: "Lo sentimos no hay suficiente stock en este momento",
                        icon: "error",
